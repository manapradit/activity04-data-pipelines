...
**Response**: `message = FALSE` only shows the code chunk without messages from R. `message = TRUE` shows long messages from R.
...
```{r college_grads_top, message=FALSE}
college_recent_grads
...
**Response**: I will use major and unemployment_rate variable.
...
```{r rearrange_college, message=FALSE}
...
```{r highest_prop_women, message=FALSE}
